...
└── faers_ui/
    ...
    └── views/
        ├── project.py      # project view     (was components/ChatView.tsx)
...
If the backend isn't running, a project falls back to an offline placeholder so
the UI stays usable during development — same behavior as the old React app.
